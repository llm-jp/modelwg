...
source convert2hf-13b/venv/bin/activate

cd convert2hf-13b/tools/convert_checkpoint/
...
echo
echo Conversion succeeded: from ${INPUT_MDS_CHECKPOINT_DIR} to ${OUTPUT_HUGGINGFACE_CHECKPOINT_DIR}
echo
